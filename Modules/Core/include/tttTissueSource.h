...
#ifndef MODULES_CORE_INCLUDE_TTTAJTISSUESOURCE_H_
#define MODULES_CORE_INCLUDE_TTTAJTISSUESOURCE_H_

#include "itkProcessObject.h"

namespace ttt{
template<class TOutputTissue> class TissueSource : public itk::ProcessObject{
public:
  /** Standard class typedefs. */
  typedef TissueSource                 Self;
  ...
  itkTypeMacro(TissueSource, ProcessObject);
  ...
  OutputTissueType * GetOutput(unsigned int idx);
...
private:
  TissueSource(const Self &) ITK_DELETE_FUNCTION;
