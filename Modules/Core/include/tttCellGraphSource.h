/*
 * tttCellGraphSource.h
 *
 *  Created on: May 12, 2016
 *      Author: morgan
 */

#ifndef MODULES_CORE_INCLUDE_TTTCELLGRAPHSOURCE_H_
#define MODULES_CORE_INCLUDE_TTTCELLGRAPHSOURCE_H_
...
namespace ttt{
template<class TOutputCellGraph> class CellGraphSource : public itk::ProcessObject{
public:
  /** Standard class typedefs. */
  typedef CellGraphSource                 Self;
  ...
  itkTypeMacro(CellGraphSource, ProcessObject);
  ...
  OutputCellGraphType * GetOutput(unsigned int idx);
...
private:
  CellGraphSource(const Self &) ITK_DELETE_FUNCTION;
...
#include "tttCellGraphSource.hxx"

#endif /* MODULES_CORE_INCLUDE_TTTCELLGRAPHSOURCE_H_ */
