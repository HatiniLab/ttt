...
#ifndef MODULES_CORE_INCLUDE_TTTAJGRAPHSOURCE_H_
#define MODULES_CORE_INCLUDE_TTTAJGRAPHSOURCE_H_

#include "itkProcessObject.h"

namespace ttt{
template<class TOutputAJGraph> class AJGraphSource : public itk::ProcessObject{
public:
  /** Standard class typedefs. */
  typedef AJGraphSource                 Self;
  ...
  itkTypeMacro(AJGraphSource, ProcessObject);
  ...
  OutputAJGraphType * GetOutput(unsigned int idx);
...
private:
  AJGraphSource(const Self &) ITK_DELETE_FUNCTION;
...
#include "tttAJGraphSource.hxx"
#endif /* MODULES_CORE_INCLUDE_TTTAJGRAPHSOURCE_H_ */
