...
class AJSegmentationDijkstraFilter: public AJGraphToAJGraphFilter<TInputAJGraph,TOutputAJGraph> {

public:
	typedef AJSegmentationDijkstraFilter Self;
...
protected:
	 ...
	 * TODO
	 */
	AJSegmentationDijkstraFilter();
	/**
	 * TODO
	 */
	virtual ~AJSegmentationDijkstraFilter();
...
#include "tttAJSegmentationDijkstraFilter.hpp"
#endif
/** @}*/
