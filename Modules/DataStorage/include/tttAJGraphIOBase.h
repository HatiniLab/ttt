...
#ifndef MODULES_DATASTORAGE_INCLUDE_TTTAJGRAPHIOBASE_H_
#define MODULES_DATASTORAGE_INCLUDE_TTTAJGRAPHIOBASE_H_
...
class AJGraphIOBase : public itk::LightProcessObject{
public:
	 /** Standard class typedefs. */
	typedef AJGraphIOBase Self;
	  ...
	  * Many file formats (i.e., subclasses) ignore this flag. */
	  ...
	  itkTypeMacro(AJGraphIOBase, LightProcessObject);
...
protected:
	  ...
	  typedef itk::IdentifierType SizeValueType;
	...
	private:
	  AJGraphIOBase(const Self &) ITK_DELETE_FUNCTION;
...
#endif /* MODULES_DATASTORAGE_INCLUDE_TTTAJGRAPHIOBASE_H_ */
